...
public class FunctionMemoryAllocator implements MemoryAllocator {
	...
	public FunctionMemoryAllocator(MemoryAccessMethod accessor, String baseAddress, int startingOffset) {
	...
	public FunctionMemoryAllocator(MemoryAccessMethod accessor,String baseAddress) {
